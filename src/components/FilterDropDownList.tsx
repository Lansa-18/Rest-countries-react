...
export default function FilterDropDownList() {
  ...
  return (
    <ul
      ...
      className={`${isDarkMode ? "bg-dark-mode-elements text-dark-mode-text" : "bg-light-mode-elements text-light-mode-text"} ${isRotated ? "block" : "hidden"} right-0 top-[7rem] z-10 w-[19%] space-y-6 rounded-lg border-red-500 py-5 text-2xl shadow-md tab-land:w-[22%] tab-port:w-[25%] custom-850:left-0 custom-850:top-[16rem] custom-850:w-[50%] custom-540:w-[65%]`}
    >
