...
export default function BackButton() {
  ...
  return (
    <button
      className={`${isDarkMode ? "bg-dark-mode-elements" : "bg-light-mode-elements"} w-[8%] rounded-lg border-red-500 shadow-lg transition-all duration-300 hover:scale-[1.05]`}
    >
      <Link
